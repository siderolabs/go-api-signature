...
#
# Generated on 2026-06-02T10:49:52Z by kres d3457c9.
...
RUN --mount=type=cache,target=/root/.cache/go-build,id=go-api-signature/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=go-api-signature/go/pkg go install github.com/shanduur/dis-vulncheck@${DIS_VULNCHECK_VERSION} \
...
WORKDIR /src
RUN --mount=type=cache,target=/root/.cache/go-build,id=go-api-signature/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=go-api-signature/go/pkg dis-vulncheck -tool=false ./...
